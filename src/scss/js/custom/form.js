;(function () {
  ...
  if(document.getElementById('phone-input-down')) {
    inputMask(document.getElementById('phone-input-down'));
  }

  if(document.getElementById('phone-input-upper')) {
    inputMask(document.getElementById('phone-input-upper'));
  }
